        ...
        <div className="container mx-auto flex justify-evenly flex-col md:flex-row gap-4 py-10 px-8">
          <div className="col flex-2/4 space-y-10">
            ...
            <div className="footer-links flex flex-col space-y-2">
              <Link className="hover:text-orange-400 hover:translate-x-2 duration-300" to="#">
                Help Center
              </Link>
              <Link className="hover:text-orange-400 hover:translate-x-2 duration-300" to="#">
            ...
            <div className="footer-social space-y-2">
              ...
              <div className="social-links flex space-x-2">
                <Facebook className="border rounded-full p-1 hover:bg-white hover:text-orange-400 cursor-pointer" size={30} />
                <Twitter className="border rounded-full p-1 hover:bg-white hover:text-orange-400 cursor-pointer" size={30} />
                <Instagram className="border rounded-full p-1 hover:bg-white hover:text-orange-400 cursor-pointer" size={30} />
              </div>
            </div>
          </div>
