  ...
  return (
    <footer className=" text-white">
      <div className="top-footer bg-neutral-800 ">
        <div className="container mx-auto flex justify-between items-center gap-4 py-10 px-8">
          <Link to="/">
            <img className="w-28" src={Images.logo} alt="Logo" />
          </Link>
          <div className="footer-sub space-y-5 w-5/12 ">
      ...
      <div className="bottom-footer bg-neutral-700 ">
        <div className="container mx-auto flex justify-evenly gap-4 py-10 px-8">
