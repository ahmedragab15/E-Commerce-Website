...
import  {SliderRight, SliderLeft } from "../components/Slider";
...
const Home = () => {
  return (
    <>
      <Header />
      <main>
        <section className="hero grid grid-cols-5 p-8 gap-4">
          <CategoryAside />
          <div className="center col-span-3 bg-gray-100 pt-10 pl-6">
            ...
            <div className="mini img-box flex justify-evenly mt-4 ">
          ...
          <div className="right">
            <div className="img-box space-y-4">
        ...
        <img src={Images.homeImgs.h2} className="Banner w-11/12 mx-auto object-cover mb-6 h-[200px]" alt="" />
